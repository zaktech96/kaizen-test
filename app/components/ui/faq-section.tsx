  ...
  ({ className, title, description, items, contactInfo, ...props }, ref) => {
    return (
      <section
        ref={ref}
        className={cn(
          "py-32 md:py-48 w-full bg-gradient-to-b from-transparent via-muted/50 to-transparent",
          className
        )}
        {...props}
      >
    ...
    return (
      ...
      >
        <Button
          ...
          className="w-full px-6 py-4 h-auto justify-between hover:bg-transparent whitespace-normal"
        >
          <h3
            className={cn(
              "text-base font-medium transition-colors duration-200 text-left text-foreground/70",
